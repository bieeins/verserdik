...
<head>
    {{--
    <base href="../" /> --}}
    <title>Dashboard Mahasiswa PPG</title>
    <meta charset="utf-8" />
    ...
    <meta property="og:title" content="Dashboard Mahasiswa PPG" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="index.html" class="d-lg-none">
                            <img alt="Logo" src="https://registrasiulang.unri.ac.id/landing/logoputih2.png"
                                class="h-30px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
                        ...
                        <div class="flex-shrink-0 app-navbar">
                            ...
                            <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                                ...
                                <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px"
                                    ...
                                    <div class="px-3 menu-item">
                                        <div class="px-3 menu-content d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <img alt="Avatar Mahasiswa"
                                                    src="{{ $mahasiswa->urlFoto ?: 'assets/media/avatars/default-avatar.jpg' }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Username-->
                                            <div class="d-flex flex-column">
                                                <div class="fw-bold d-flex align-items-center fs-7">{{
                                                    ucwords(strtolower($mahasiswa->namaPeserta)) }}
                                                    {{-- <span
                                                        class="px-2 py-1 badge badge-light-success fw-bold fs-8 ms-2">Prodi</span>
                                                    --}}
                                                </div>
                                                <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{
                                                    $mahasiswa->namaBidangStudi }}</a>
                                            </div>
                                            <!--end::Username-->
                                        </div>
                                    </div>
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="px-5 menu-item">
                                        <a href="{{ route('mahasiswa.logout') }}" class="px-5 menu-link">Sign Out</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                ...
                                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link active" href="account/overview.html">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Overview</span>
                                    ...
                                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                        ...
                                        <!--begin:Menu sub-->
                                        <div
                                            class="px-2 py-4 overflow-auto menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown w-200px mh-75">
                                            <!--begin:Menu item-->
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                        ...
                        <div id="kt_app_toolbar" class="py-3 app-toolbar py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                                    <!--begin::Title-->
                                    <h1
                                        class="my-0 text-gray-900 page-heading d-flex fw-bold fs-3 flex-column justify-content-center">
                                ...
                                {{-- <div class="gap-2 d-flex align-items-center gap-lg-3">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            data-kt-menu="true" id="kt_menu_673c0c9b689d9">
                                            <!--begin::Header-->
                                            <div class="py-5 px-7">
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <div>
                                                        <select class="form-select form-select-solid"
                                                            ...
                                                            data-dropdown-parent="#kt_menu_673c0c9b689d9"
                                    ...
                                    <div class="pb-0 card-body pt-9">
                                        ...
                                        <div class="flex-wrap d-flex flex-sm-nowrap">
                                            ...
                                            <div class="flex-grow-1">
                                                 <!--begin::Notice-->
                                                <div class="p-6 mb-5 border border-dashed rounded notice d-flex bg-light-warning border-warning">
                                                    <!--begin::Icon-->
                                                    ...
                                                    <div class="d-flex flex-stack flex-grow-1">
                                                        ...
                                                        <div class="text-justify fw-semibold">
                                                            ...
                                                            <div class="text-gray-700 fs-6">
                                                                Pada halaman Verifikasi Data Sertifikat Pendidik (Serdik) PPG, pastikan hal-hal berikut ini sudah diperiksa untuk menjamin keabsahan dan kelengkapan data:
                                                                <ol>
                                                                    <li><strong>Nomor Induk Kependudukan (NIK)</strong>: Periksa NIK yang terdaftar pada sertifikat PPG. Pastikan NIK yang dimasukkan pada halaman verifikasi sesuai dengan yang tercantum pada Kartu Tanda Penduduk (KTP) Anda.</li>
                                                                    <li><strong>Nama Lengkap</strong>: Pastikan Nama Lengkap yang terdaftar pada sertifikat PPG sesuai dengan data pribadi Anda yang ada di dokumen resmi seperti KTP dan data akademik (Ijazah S1). Nama yang salah atau tidak sesuai dapat menyebabkan masalah dalam validasi data.</li>
                                                                    <li><strong>Tempat Tanggal Lahir</strong>: Pastikan Tempat Tanggal Lahir yang terdaftar pada sertifikat PPG sesuai dengan data pribadi Anda yang ada di dokumen resmi seperti KTP dan data akademik (Ijazah S1).</li>
                                                                    <li><strong>NIM (Nomor Induk Mahasiswa)</strong>: Pastikan NIM yang terdaftar di sertifikat sesuai dengan yang ada pada dokumen resmi KTM yang diterbitkan oleh LPK Universitas Riau.</li>
                                                                    <li><strong>Tanggal Penerbitan Sertifikat</strong>: Untuk Piloting 1 adalah tanggal 21 Oktober 2024.</li>
                                                                </ol>
                                                            </div>
                                                        </div>
                                                        <!--end::Content-->
                                                ...
                                                {{-- <div class="flex-wrap d-flex flex-stack">
                                                    ...
                                                    <!--begin::Progress-->
                                                    <div
                                                        class="mt-3 d-flex align-items-center w-200px w-sm-300px flex-column">
                                                        ...
                                                        <div class="mx-3 mb-3 h-5px w-100 bg-light">
                                                            <div class="rounded bg-success h-5px" role="progressbar"
                                    ...
                                    <div class="pb-0 card-body pt-9">
                                        ...
                                        <div class="flex-wrap d-flex flex-sm-nowrap">
                                            ...
                                            <div class="flex-grow-1">
                                                <!--begin::Title-->
                                                <div
                                                    class="flex-wrap mb-2 d-flex justify-content-between align-items-start">
                                                    <!--begin::User-->
                                                    <div class="d-flex flex-column">
                                                        <!--begin::Name-->
                                                            ...
                                                            <div class="py-3 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                                                ...
                                                                <div class="px-3 menu-item" data-kt-menu-trigger="hover"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="px-3 menu-item">
                                                                            <a href="#"
                                                                                class="px-3 menu-link">Billing</a>
                                                                        </div>
                                                                        <!--end::Menu item-->
                                                                        <!--begin::Menu item-->
                                                                        <div class="px-3 menu-item">
                                                                            <a href="#"
                                                                                class="px-3 menu-link">Statements</a>
                                                                        </div>
                                                                        <!--end::Menu item-->
                                                                        <!--begin::Menu separator-->
                                                                        <div class="my-2 separator"></div>
                                ...
                                <div class="mb-5 card mb-xl-10" id="kt_profile_details_view">
                                    ...
                                    <div class="card-body p-9">
                                        ...
                                        <div class="row mb-7">
                                            ...
                                            <div class="col-lg-8">
                                                <a target="_blank" href="{{ $mahasiswa->linkPreviewSertifikat}}"
                                                    class="text-gray-800 fw-semibold fs-6 text-hover-primary">{{ $mahasiswa->nomorSertifikatPendidik }}</a>
                                                {{-- <span class="text-gray-800 fw-bold fs-6">{{ $mahasiswa->nomorSertifikatPendidik }}</span> --}}
                                            </div>
                                        ...
                                        <div class="row mb-7">
                                            ...
                                            <div class="col-lg-8">
                                                {{-- <a href="#"
                                                    class="text-gray-800 fw-semibold fs-6 text-hover-primary">{{ $mahasiswa->nim }}</a> --}}
                                        ...
                                        <!--begin::Notice-->
                                        <div
                                            class="p-6 border border-dashed rounded notice d-flex bg-light-warning border-warning">
                                            <!--begin::Icon-->
                                            <i class="ki-duotone ki-information fs-2tx text-danger me-4">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            ...
                                            <div class="pt-5 card-header flex-nowrap">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                                        ...
                                                        <div class="px-3 menu-item">
                                                            <div
                                                                class="px-3 py-4 text-gray-900 menu-content fs-6 fw-bold">
                                                                Quick Actions</div>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu separator-->
                                            ...
                                            <div class="card-body d-flex flex-column flex-center">
                                                ...
                                                <div class="mb-1 text-center">
                                                    ...
                                                    <a class="btn btn-sm btn-light"
                                                        href="apps/invoices/view/invoice-1.html">Learn more</a>
                                                    <!--end::Link-->
                                                </div>
                                                <!--end::Links-->
                                            </div>
                                        ...
                                        <div class="card card-flush h-xl-100">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                                    <!--begin::Item-->
                                                    <div
                                                        class="py-3 mb-6 border border-gray-300 border-dashed rounded px-7">
                                                        <!--begin::Info-->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <table class="table align-middle table-row-dashed fs-6 gy-3"
                                                    ...
                                                    <thead>
                                                        <!--begin::Table row-->
                                                        <tr
                                                            class="text-gray-500 text-start fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <tbody class="text-gray-600 fw-bold">
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                <span
                                                                    class="px-4 py-3 badge fs-7 badge-light-primary">In
                                                                    Stock</span>
                                                            </td>
                                                            <!--end::Status-->
                                                            <!--begin::Qty-->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                <span
                                                                    class="px-4 py-3 badge fs-7 badge-light-danger">Out
                                                                    of Stock</span>
                                                            </td>
                                                            <!--end::Status-->
                                                            <!--begin::Qty-->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                <span
                                                                    class="px-4 py-3 badge fs-7 badge-light-warning">Low
                                                                    Stock</span>
                                                            </td>
                                                            <!--end::Status-->
                                                            <!--begin::Qty-->
                    ...
                    <div id="kt_app_footer" class="app-footer">
                        ...
                        <div
                            ...
                            <div class="order-2 text-gray-900 order-md-1">
                                ...
                                <a href="#" target="_blank" class="text-gray-800 text-hover-primary">Tim PPG</a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Menu-->
                    ...
                    <div class="timeline timeline-border-dashed">
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="mb-10 timeline-content mt-n1">
                                ...
                                <div class="mb-5 pe-3">
                                    <!--begin::Title-->
                                    <div class="mb-2 fs-5 fw-semibold">There are 2 new tasks for you in “AirPlus Mobile
                                        App” project:</div>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="mb-10 timeline-content mt-n1">
                                ...
                                <div class="mb-5 pe-3">
                                    <!--begin::Title-->
                                    <a href="#" class="mb-2 text-gray-800 fs-5 fw-semibold text-hover-primary">3 New
                                    ...
                                    <div
                                        ...
                                        <div class="flex-wrap d-flex flex-stack flex-grow-1 flex-md-nowrap">
                                            ...
                                            <div class="mb-3 mb-md-0 fw-semibold">
                                                ...
                                                <div class="text-gray-700 fs-6 pe-7">Login into Admin Dashboard to make
    ...
    <!--begin::Modal - Lapor App-->
    <div class="modal fade" id="kt_modal_lapor" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="pt-0 pb-10 mx-5 modal-body scroll-y mx-xl-10">
                    ...
                    <!--end::Separator-->
                    <!--begin::Textarea-->
                    <textarea class="mb-5 form-control form-control-solid" rows="6"
                ...
                <div class="px-5 pt-0 modal-body pb-15 px-xl-20">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="mx-auto nav-group nav-group-outline" data-kt-buttons="true">
                            <button class="px-6 py-3 btn btn-color-gray-500 btn-active btn-active-secondary me-2 active"
                                ...
                                <div class="p-10 rounded tab-content h-100 bg-light">
                                    ...
                                    <div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
                                        ...
                                        <div class="pt-1">
                                            ...
                                            <div class="d-flex align-items-center mb-7">
                                                <span class="text-gray-700 fw-semibold fs-5 flex-grow-1">Up to 10 Active
                                                    Users</span>
                                    ...
                                    <div class="tab-pane fade" id="kt_upgrade_plan_enterprise">
                                        ...
                                        <div class="pt-1">
                                            ...
                                            <!--begin::Item-->
                                            <div class="d-flex align-items-center">
                                                <span class="text-gray-700 fw-semibold fs-5 flex-grow-1">Unlimited Cloud
                                                    Space</span>
                                                <i class="ki-duotone ki-check-circle fs-1 text-success">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                            ...
                            <form class="form" novalidate="novalidate" id="kt_modal_create_app_form">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="mb-10 row">
                                            ...
                                            <div class="col-md-8 fv-row">
                                                <!--begin::Label-->
                                                <label class="mb-2 required fs-6 fw-semibold form-label">Expiration
                                                    Date</label>
                                                <!--end::Label-->
                                                <!--begin::Row-->
                                ...
                                <div data-kt-stepper-element="content">
                                    <div class="text-center w-100">
                                        <!--begin::Heading-->
                                        <h1 class="mb-3 text-gray-900 fw-bold">Release!</h1>
                                        <!--end::Heading-->
                                        <!--begin::Description-->
            ...
            <div class="modal-content">
                ...
                <div class="m-5 modal-body scroll-y">
                    ...
                    <div class="stepper stepper-links d-flex flex-column" id="kt_modal_offer_a_deal_stepper">
                        ...
                        <!--end::Nav-->
                        <!--begin::Form-->
                        <form class="pb-10 mx-auto mw-500px w-100 pt-15" novalidate="novalidate"
                            ...
                            <div class="current" data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-15" data-kt-buttons="true">
                                        <!--begin::Option-->
                                        <label
                                            class="p-6 mb-6 btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start active">
                                            <!--begin::Input-->
                                            ...
                                            <span class="d-flex">
                                                ...
                                                <!--begin::Info-->
                                                <span class="ms-4">
                                                    <span class="mb-2 text-gray-900 fs-3 fw-bold d-block">Personal
                                                        Deal</span>
                                        ...
                                        <label
                                            ...
                                            <span class="d-flex">
                                                ...
                                                <!--begin::Info-->
                                                <span class="ms-4">
                                                    <span class="mb-2 text-gray-900 fs-3 fw-bold d-block">Corporate
                                                        Deal</span>
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="mb-8 fv-row">
                                        <!--begin::Label-->
                                        <label class="mb-2 required fs-6 fw-semibold">Customer</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                    ...
                                    <div class="mb-8 fv-row">
                                        <!--begin::Label-->
                                        <label class="mb-2 required fs-6 fw-semibold">Deal Title</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid"
                                    ...
                                    <div class="mb-8 fv-row">
                                        <!--begin::Label-->
                                        <label class="mb-2 fs-6 fw-semibold">Deal Description</label>
                                        <!--end::Label-->
                                        <!--begin::Label-->
                                    ...
                                    <!--begin::Input group-->
                                    <div class="mb-8 fv-row">
                                        <label class="mb-2 required fs-6 fw-semibold">Activation Date</label>
                                        <div class="position-relative d-flex align-items-center">
                                            <!--begin::Icon-->
                                            <i class="mx-4 ki-duotone ki-calendar-8 fs-2 position-absolute">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                                <span class="path3"></span>
                                                <span class="path4"></span>
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="mb-8 fv-row">
                                        ...
                                        <div class="position-relative w-lg-250px" id="kt_modal_finance_setup"
                                            ...
                                            <!--begin::Input control-->
                                            <input type="text" class="border-0 form-control form-control-solid ps-12"
                                    ...
                                    <div class="mb-8 fv-row">
                                        <!--begin::Label-->
                                        <label class="mb-2 fs-6 fw-semibold">Budget Usage</label>
                                        <!--end::Label-->
                                        <!--begin::Row-->
                                        <div class="row g-9" data-kt-buttons="true"
                                            ...
                                            <div class="col-md-6 col-lg-12 col-xxl-6">
                                                ...
                                                <label
                                                    ...
                                                    <!--begin::Info-->
                                                    <span class="ms-5">
                                                        <span class="mb-2 text-gray-800 fs-4 fw-bold d-block">Precise
                                                            Usage</span>
                                                        <span class="text-gray-600 fw-semibold fs-7">Withdraw money to
                                            ...
                                            <div class="col-md-6 col-lg-12 col-xxl-6">
                                                ...
                                                <label
                                                    ...
                                                    <!--begin::Info-->
                                                    <span class="ms-5">
                                                        <span class="mb-2 text-gray-800 fs-4 fw-bold d-block">Extreme
                                                            Usage</span>
                                                        <span class="text-gray-600 fw-semibold fs-7">Withdraw money to
                                                            your bank account per transaction under $50,000
                                                            budget</span>
                ...
                <div class="pt-0 mx-5 modal-body scroll-y mx-xl-18 pb-15">
                    ...
                    <div id="kt_modal_users_search_handler" data-kt-search-keypress="true" data-kt-search-min-length="2"
                        ...
                        <form data-kt-search-element="form" class="mb-5 w-100 position-relative" autocomplete="off">
                            ...
                            <!--begin::Icon-->
                            <i
                                class="text-gray-500 ki-duotone ki-magnifier fs-2 fs-lg-1 position-absolute top-50 ms-5 translate-middle-y">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i>
                            <!--end::Icon-->
        ...
        <div class="modal-dialog mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="pt-0 mx-5 modal-body scroll-y mx-xl-18 pb-15">
                    ...
                    <!--end::Separator-->
                    <!--begin::Textarea-->
                    <textarea class="mb-8 form-control form-control-solid" rows="3"
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="#" class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">Melody
                                            Macy</a>
                                        <div class="fw-semibold text-muted">melody@altbox.com</div>
                                    </div>
                                    <!--end::Details-->
                            ...
                            <div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="#" class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">Mikaela
                                            Collins</a>
                                        <div class="fw-semibold text-muted">mik@pex.com</div>
                                    </div>
                                    <!--end::Details-->
                            ...
                            <div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="#" class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">Francis
                                            Mitcham</a>
                                        <div class="fw-semibold text-muted">f.mit@kpmg.com</div>
                                    </div>
                                    <!--end::Details-->
                            ...
                            <div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="#" class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">Olivia
                                            Wild</a>
                                        <div class="fw-semibold text-muted">olivia@corpmail.com</div>
                                    </div>
                                    <!--end::Details-->
                            ...
                            <div class="py-4 border-gray-300 d-flex flex-stack border-bottom border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Details-->
                                    <div class="ms-5">
                                        <a href="#" class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">Robert
                                            Doe</a>
                                        <div class="fw-semibold text-muted">robert@benko.com</div>
                                    </div>
                                    <!--end::Details-->
